 ...
 * <a href="http://google.github.io/flatbuffers/md__java_usage.html">
 * "Use in Java"</a> in the main FlatBuffers documentation.
 */
public class FlatBufferBuilder {
	...
	/**
	 * Prepare to write an element of {@code size} after
	 * {@code additional_bytes} have been written, e.g. if you write a string,
	 * you need to align such the int length field is aligned to
	 ...
	 * {@code additional_bytes} will be 0.
	 *
	 * @param size
	 ...
	 * directly. The {@code FlatBuffers} compiler will create a start/end method
	 * for vector types in generated code.
	 * <p>
	 ...
	 *
	 * @param s
	 *            An already encoded UTF-8 string
	 * @return The offset in the buffer where the encoded string starts
	 */
	 ...
	 * call this directly. The {@code FlatBuffers} compiler will generate helper
	 * methods that call this method internally.
	 * <p>
	 * For example, using the "Monster" code found on the
	 * <a href="http://google.github.io/flatbuffers/md__java_usage.html">landing
	 * page</a>. An object of type {@code Monster} can be created using the
	 * following code:
	 *
	 * <pre>
	 * {
	 ...
	 * Here:
	 * <ul>
	 * <li>The call to {@code Monster#startMonster(FlatBufferBuilder)} will call
	 * this method with the right number of fields set.</li>
	 * <li>{@code Monster#endMonster(FlatBufferBuilder)} will ensure
	 * {@link #endObject()} is called.</li>
	 * </ul>
	 * <p>
	 * It's not recommended to call this method directly. If it's called
	 * manually, you must ensure to audit all calls to it whenever fields are
	 * added or removed from your schema. This is automatically done by the code
	 * generated by the {@code FlatBuffers} compiler.
	 *
	 * @param numfields
	 ...
	 *
	 * @param forceDefaults
	 *            true always serializes default values
	 * @return this
	 */

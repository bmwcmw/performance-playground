...
public class Table {
	...
	// with an
	// accessor based on __vector_as_bytebuffer below, which is much more
	// efficient,
	...
	// Get a whole vector as a ByteBuffer. This is efficient, since it only
	// allocates a new
	// bytebuffer object, but does not actually copy the data, it still refers
	// to the same
